  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () =>
            _showAddPart(context, db, moto?.id, moto?.rimType ?? 'alloy'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isPermanent)
            const Text(
              'No requiere cambio (filtro permanente)',
            ...
            Row(
              children: [
                ...
                Text(
                  _remaining > 0
                      ? 'Faltan $_remaining km'
                      : 'Vencida ${_remaining.abs()} km',
                  style: TextStyle(
                    color: _statusColor,
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                'Último: ${DateFormat('dd/MM/yyyy').format(part.lastChangedDate)} · ${part.lastChangedKm} km',
                style: const TextStyle(
                  color: AppTheme.textSecondary,
                  fontSize: 12,
                ),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: AppTheme.parts.withValues(alpha: 0.5),
                    ),
  ...
  void _registerChange(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: AppTheme.surface,
        title: Text(
          _isPermanent ? 'Limpieza: ${part.name}' : 'Cambio: ${part.name}',
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final comboParts = parts.where((p) {
                ...
                return p.partCategory == 'sprocket' ||
                    name.contains('porta corona');
              });
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(
                  value: 'oil_filter',
                  child: Text('Filtro de aceite'),
                ),
                DropdownMenuItem(
                  value: 'fuel_filter',
                  child: Text('Filtro de gasolina'),
                ),
                DropdownMenuItem(value: 'chain', child: Text('Cadena')),
                DropdownMenuItem(
                  value: 'sprocket',
                  child: Text('Piñón / Corona'),
                ),
                DropdownMenuItem(
                  value: 'clutch',
                  child: Text('Clutch / Crochera'),
                ),
                DropdownMenuItem(
                  value: 'engine_timing',
                  child: Text('Distribución / tiempo'),
                ),
                DropdownMenuItem(
                  value: 'valvetrain',
                  child: Text('Tren de válvulas'),
                ),
                DropdownMenuItem(
                  value: 'engine_internal',
                  child: Text('Motor interno'),
                ),
                DropdownMenuItem(
                  value: 'gasket',
                  child: Text('Empaques / retenes'),
                ),
                DropdownMenuItem(
                  value: 'fork',
                  child: Text('Barras / Suspensión delantera'),
                ),
                DropdownMenuItem(value: 'bearing', child: Text('Rodamiento')),
                DropdownMenuItem(
                  value: 'electrical',
                  child: Text('Eléctrico / Encendido'),
                ),
                DropdownMenuItem(
                  value: 'brake_front',
                  child: Text('Freno delantero'),
                ),
                DropdownMenuItem(
                  value: 'brake_rear',
                  child: Text('Freno trasero'),
                ),
                DropdownMenuItem(value: 'tire', child: Text('Llanta')),
                DropdownMenuItem(
                  value: 'sealant',
                  child: Text('Antipinchazo / Slime'),
                ),
                DropdownMenuItem(
                  value: 'coolant',
                  child: Text('Líquido refrigerante'),
                ),
              ...
              onChanged: (v) => setState(() {
                ...
                } else if (_category == 'bearing' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '25000';
                } else if (_category == 'electrical' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '40000';
                } else if (_category == 'engine_timing' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '40000';
                } else if (_category == 'valvetrain' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '40000';
                } else if (_category == 'engine_internal' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '50000';
                } else if (_category == 'gasket' &&
                    _intervalCtrl.text.isEmpty) {
                  _intervalCtrl.text = '30000';
                }
              }),
                ...
                return GestureDetector(
                  onTap: () => setState(() {
                    ...
                    if (_intervalCtrl.text.isEmpty) {
                      _intervalCtrl.text = ct['value'] == 'standard'
                          ? '15000'
                          : '25000';
                    }
                  }),
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? AppTheme.parts.withValues(alpha: 0.12)
                          : AppTheme.card,
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                    ...
                    child: Text('Rueda delantera'),
                  ),
                  DropdownMenuItem(
                    value: 'Rueda trasera',
                    child: Text('Rueda trasera'),
                  ),
                  DropdownMenuItem(
                    value: 'Dirección',
                  ...
                  DropdownMenuItem(
                    value: 'Tijera / basculante',
                    child: Text('Tijera / basculante'),
                  ),
                  DropdownMenuItem(value: 'Motor', child: Text('Motor')),
                  DropdownMenuItem(
                    value: 'Culata / cámara',
                    child: Text('Culata / cámara'),
                  ),
                  DropdownMenuItem(
                    value: 'Distribución / tiempo',
                    child: Text('Distribución / tiempo'),
                  ),
                  DropdownMenuItem(
                    value: 'Crochera / clutch',
                    child: Text('Crochera / clutch'),
                  ),
                  DropdownMenuItem(
                    value: 'Sistema eléctrico',
                    child: Text('Sistema eléctrico'),
                  ),
                  DropdownMenuItem(
                    value: 'Suspensión delantera',
                    child: Text('Suspensión delantera'),
                  ),
                  DropdownMenuItem(
                    value: 'Suspensión trasera',
                    child: Text('Suspensión trasera'),
                  ),
                ],
            ...
            if (_category == 'tire') ...[
              ...
              ...AppConstants.tireTypes
                  .where(
                    (t) => AppConstants.compatibleTireTypes(
                      widget.rimType,
                    ).contains(t['value']),
                  )
                  .map((t) {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final filterType = _category == 'oil_filter'
                    ? _filterType
                    : null;
                final brakeType =
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected
              ? AppTheme.parts.withValues(alpha: 0.15)
              : AppTheme.card,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: selected ? AppTheme.parts : Colors.transparent,
            width: 1.5,
          ),
        ),
        child: Text(
        ...
        return Column(
          ...
          children: [
            ...
            ...history
                .take(50)
                .map(
                  (h) => _HistoryEntry(entry: h, db: db, currency: currency),
                ),
          ],
        );
      },
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                        DateFormat('dd/MM/yyyy').format(changedAt),
                        style: const TextStyle(color: AppTheme.textPrimary),
                      ),
                    ],
                  ),

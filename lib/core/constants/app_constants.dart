class AppConstants {
  ...
  static const Map<String, List<String>> maintenanceCategories = {
    'Motor': [
      ...
      'Cambio de empaque tapa de válvulas',
    ],
    'Distribución / tren de válvulas': [
      'Árbol de levas',
      'Cadena de tiempo',
      'Tensor de cadena de tiempo',
      'Guías / patines de cadena de tiempo',
      'Balancines / seguidores',
      'Pastillas / shims de válvula',
